...
# 3. 各グループごとにファイルを保存する
group_a.to_csv("mainfiles/mainfiles/groupa_data.csv", index=False)
group_b.to_csv("mainfiles/mainfiles/groupb_data.csv", index=False)
group_c.to_csv("mainfiles/mainfiles/groupc_data.csv", index=False)
